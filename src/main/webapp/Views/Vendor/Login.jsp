...
<title>Đăng Nhập - Dành Cho Các Nhà Bán Hàng</title>
<!-- Link Google Fonts -->
<link
	...
	<div class="login-container">
		...
		<form>
			<label for="username">Tên đăng nhập hoặc email *</label> <input
				...
				required> <label for="password">Mật khẩu *</label> <input
				type="password" id="password" placeholder="Mật khẩu của bạn"
				required>

			<div class="actions">
				<label><input type="checkbox"> Ghi nhớ tôi</label> <a
